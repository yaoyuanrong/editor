<template>
  <node-view-wrapper ref="containerRef" class="umo-node-view umo-code-block">
    <div :class="`umo-node-container hover-shadow umo-node-code-block umo-node-code-block-theme-${node.attrs.theme}`">
      <div class="umo-node-code-block-toolbar">
        <div class="umo-node-code-block-toolbar-left">
          <menus-button :text="t('bubbleMenu.code.languages')" menu-type="select" style="width: 100px"
            :select-options="languageOptions" :select-value="node.attrs.language" :popup-props="{
              attach: container,
